...
public class RaytracingRendererFeature : ScriptableRendererFeature
{
    ...
    class RaytracingPass : ScriptableRenderPass
    {
        ...
        // the render pass.
        public void Setup(ComputeShader cs, RenderTexture rtDesc)
        {
            this.cs = cs;
            this._target = rtDesc;
        }
    ...
    public override void Create()
    {
        ...
        m_ComputePass = new RaytracingPass();
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        m_ComputePass.Setup(computeShader, canvasRT);
